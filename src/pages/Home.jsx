...
function Hero() {
    return (
        <section className="hero">
            <div className="hero-eyebrow">AI-assisted Google reviews for businesses</div>
            ...
            <div className="hero-comics">
                <div className="comic-panel">
                    ...
                    <div className="comic-img">
                        ...
                        <img src="/images/comic-1-leaving.webp" alt="Customer leaving without reviewing" />
                    </div>
                </div>
                <div className="comic-panel">
                    ...
                    <div className="comic-img">
                        ...
                        <img src="/images/comic-2-scanning.webp" alt="Customer scanning QR card" />
                    </div>
                </div>
            </div>
            ...
            <div className="hero-workflow">
                ...
                <span className="wf-step">Select options</span>
                <span className="wf-arrow">→</span>
